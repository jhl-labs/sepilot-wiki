 ...
 * 매주 월요일 실행
 *
 * scripts/maintenance/normalize-tags.js를 호출
 */
...
export class NormalizeTagsJob extends BaseJob {
  readonly name = 'normalize-tags';
  readonly description = '문서 태그 정규화';
  readonly schedule = '0 2 * * 1'; // 매주 월요일 02시
