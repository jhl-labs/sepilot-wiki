 ...
 * 수동 전용 (cron 스케줄 비활성화)
 *
 * scripts/maintenance/detect-doc-updates.js를 호출
 */
...
export class DetectDocUpdatesJob extends BaseJob {
  readonly name = 'detect-doc-updates';
  readonly description = '코드 변경 기반 문서 업데이트 감지';
  readonly schedule = '0 0 31 2 *'; // 수동 전용 (실행되지 않는 스케줄)
