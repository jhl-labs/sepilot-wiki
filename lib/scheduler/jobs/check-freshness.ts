 ...
 * 매주 일요일 실행
 *
 * scripts/maintenance/check-freshness.js를 호출
 */
...
export class CheckFreshnessJob extends BaseJob {
  readonly name = 'check-freshness';
  readonly description = '문서 최신성 자동 점검';
  readonly schedule = '0 0 * * 0'; // 매주 일요일 자정
