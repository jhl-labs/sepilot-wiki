 ...
 * 매월 1일 실행
 *
 * scripts/maintenance/score-quality.js를 호출
 */
...
export class ScoreQualityJob extends BaseJob {
  readonly name = 'score-quality';
  readonly description = '문서 품질 스코어링';
  readonly schedule = '0 2 1 * *'; // 매월 1일 02시
