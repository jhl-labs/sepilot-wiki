...
- **필터링 기법**  
  - **컨텍스트 힌트**: 타임스탬프, 사용자 기본 설정, 세션 상태 등 명시적 메타데이터를 활용해 관련성을 판단한다.  
  - **컨텍스트 엔지니어링**: Elastic의 가이드에 따라 검색·도구 선택을 위한 명시적 힌트를 프롬프트에 포함한다[[컨텍스트 엔지니어링이란 무엇인가요?](https://www.elastic.co/kr/what-is/context-engineering)].  
