...
| **3. LiteRT delegate 로드** | `lite_rt_delegate = tf.lite.experimental.load_delegate('lite_rt')`<br>`interpreter = tflite.Interpreter(model_path="model.tflite", experimental_delegates=[lite_rt_delegate])` | `interpreter.allocate_tensors