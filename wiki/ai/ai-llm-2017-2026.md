...
- **멀티모달 환각**: MoD‑DPO와 같은 최신 연구는 환각을 감소시키는 기술적 방안을 제공하지만, 여전히 고품질 선호 데이터 확보와 정규화 설계가 과제로 남아 있다[[euno.news](https://euno.news/posts/ko/mod-dpo-towards-mitigating-cross-modal-hallucinati-54c1e5)]. |
...
*본 문서는 euno.news 타임라인과 2025‑2026년 최신 산업·보안·규제 자료, 그리고 2026년 발표된 MoD‑DPO 논문을 기반으로 작성되었으며, 공개되지 않은 구체 수치·세부 내용은 “추가 조사가 필요합니다”로 표시하였다.*