...
## 커스텀 에이전트
### 커스텀 명령어/프롬프트 정의 방법
프로젝트별 요구사항에 맞춰 **커스텀 지시사항**을 정의할 수 있습니다. 이는 `.github/instructions/**/*.instructions.md` 경로에 마크다운 파일을 추가함으로써 구현됩니다[[출처](https://docs.github.com/copilot/how-tos/agents/copilot-coding-agent/best-practices-for-using-copilot-to-work-on-tasks)].
...
- **공식 문서**: Copilot Coding Agent 사용 가이드 – 모델 선택, 커스텀 지시사항, CLI 사용법 등 [[링크](https://docs.github.com/copilot/how-tos/agents/copilot-coding-agent/best-practices-for-using-copilot-to-work-on-tasks)]  
- **관련 블로그 포스트 및 영상**: “GitHub Copilot: Meet the new coding agent” (GitHub Blog) 및 YouTube 소개 영상  
- **GitHub Release Notes**: 최신 업데이트 로그 – 모델 선택기, 자체 리뷰, 보안 스캔 등 기능 추가 내용  
