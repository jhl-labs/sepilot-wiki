...
## 문서 개요
- **목적**: 최신 Kubernetes 마이너 버전(v1.28, v1.27, v1.26)의 핵심 변경 사항을 5줄 이내로 요약해 운영자가 빠르게 파악하고 업그레이드 시 참고하도록 합니다.  
...
| **버전 체계** | `v1.<minor>.0` (예: v1.28.0) – `<minor>`는 마이너 릴리즈 번호이며, 패치 버전은 `v1.<minor>.<patch>` 형태입니다. |
| **지원 정책** | 최신 3개 마이너 버전(현재 v1.28, v1.27, v1.26)은 약 1년간 전체 지원을 받으며, 이후는 보안 패치만 제공됩니다. |
