...
> 참고: 공식 릴리즈 페이지는 [Kubernetes v1.36.0 Release](https://github.com/kubernetes/kubernetes/releases/tag/v1.36.0)이며, **1685개의 커밋**이 포함된 릴리즈입니다. 자세한 변경 사항은 CHANGELOG를 확인하십시오.
