...
> 참고: 공식 릴리즈 페이지는 [Kubernetes v1.36.0 Release](https://github.com/kubernetes/kubernetes/releases/tag/v1.36.0)이며, **1569개의 커밋**이 포함된 릴리즈입니다. 자세한 변경 사항은 CHANGELOG를 확인하십시오.
...
- **KEP Repository**: <https://github.com/kubernetes/enhancements/tree/master/keps> – Kubernetes Enhancement Proposals (KEPs) 저장소로, 모든 KEP와 SIG 별 디렉터리를 포함합니다 (특히 `sig-node/2369-dynamic-resource-allocation`).  
